...
with smile:
    ...
    import re, hashlib
    import numpy as np
    from src.smile_base.Model.graph_node import GraphNode
    from src.smile_base.Model.data_level.hypothesis import Hypothesis, SPARQLDict
    from src.smile_base.Model.controller.trace import Trace, SPARQLDict
    print()
