...
class Stakeholder(Hypothesis,cids.Stakeholder):
    """
    ...
    klass_relations = {
        ...
        'activity': {'pred':cids.performs, 'cardinality':'many'},
        'organization': {'pred':cids.forOrganization, 'cardinality':'one'},
        'catchment_area': {'pred':cids.hasCatchmentArea, 'cardinality':'one'},
