...
class ParseTokenize(KnowledgeSource):
    ...
    RULE_WEIGHTS = pd.read_csv("pyscript/app/scripts/rule_ranking_merged_on_mcc.csv")
    ...
    def set_input(self, description):
        ...
        print('b', len(self.store_hypotheses))
        self.set_ners()
        print('c', len(self.store_hypotheses))
        self.set_spos()
        print('d', len(self.store_hypotheses))
        self.set_phrases()
        print('e', len(self.store_hypotheses))
        self.set_r_t()
        print('f', len(self.store_hypotheses))
        self.set_r_e()
    ...
    def get_outputs(self):
        ...
        self.get_basics()
        print('2', len(self.store_hypotheses))
        self.get_ners()
        print('3', len(self.store_hypotheses))
        self.get_spos()
        print('4', len(self.store_hypotheses))
        self.get_phrases()
        print('5', len(self.store_hypotheses))
        self.get_r_t()
        print('6', len(self.store_hypotheses))
        self.get_r_e()
    ...
    def get_basics(self):
        ...
        if self.annotation["Word and Pos"] is not None:
            for token in self.annotation["Word and Pos"]:
                ...
                print("\tg.1.3", len(self.store_hypotheses))

        print("\tg.2.1", len(self.store_hypotheses))
        if self.annotation["Dep"] is not None:
            for v in self.annotation["Dep"]:
                print("\tg.2.2", len(self.store_hypotheses))
                dep = v[1]
                ...
                print("\tg.2.3", len(self.store_hypotheses))

        print("\tg.3.1", len(self.store_hypotheses))
        if self.annotation["CoRef"] is not None:
            for v in self.annotation["CoRef"]:
                print("\tg.3.2", len(self.store_hypotheses))
                ...
                print("\tg.3.3", len(self.store_hypotheses))
