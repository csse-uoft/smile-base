...
class Ner(Hypothesis):
    ...
    klass_relations = {
        'entity' : {'pred':smile.hasEntity, 'cardinality':'one'},
    ...
    def show(self):
        return self.entity or ''


    @classmethod
    def find(cls, trace_id, phrase_id, entity,request_id=None):
    ...
    @classmethod
    def generate(cls,  trace_id, phrase_id, entity, certainty=0, request_id=None):
    ...
    @classmethod
    def find_generate(cls, trace_id, phrase_id, entity, request_id=None, certainty=0):
