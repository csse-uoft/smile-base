...
class Output(Hypothesis,cids.Output):
    """
    ...
    klass_relations = {
        ...
        'stakeholder_outcome': {'pred':cids.hasStakeholderOutcome, 'cardinality':'many'},
        'location': {'pred':i72.located_in, 'cardinality':'many'},
        'can_produce': {'pred':cids.produces, 'cardinality':'many'},
        'activity': {'pred':org.forActivity, 'cardinality':'many'},
        'has_value': {'pred':i72.value, 'cardinality':'many'},
    }
